...
import { CoreModule, PlatformLanguageToken, PlatformWindowToken } from '@frontend/core';
...
export class FrontendCoreModule {
  constructor(
    @Optional()
    @SkipSelf()
    parentModule: FrontendCoreModule
  ) {
    throwIfAlreadyLoaded(parentModule, 'FrontendCoreModule');
  }
}
